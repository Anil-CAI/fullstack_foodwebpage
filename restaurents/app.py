...
app = Flask(
    __name__,
    template_folder=os.path.join(PROJECT_ROOT, 'restaurents', 'templates'),  # templates path
    static_folder=os.path.join(PROJECT_ROOT, 'static')                      # static path
)
...
@app.route('/')
def home():
    # Make sure restaurants.html is in restaurents/templates/
